...
class Carbon extends DateTime
{
    ...
    /**
     * A table Carbon instance to be returned when now instances are created
     *
     * @var Carbon
     */
     ...
     * for more on the possibility of this constructor returning a table instance.
     *
    ...
    {
        // If the class has a table now set and we are trying to create a now()
     ...
     *
     * To clear the table instance call this method using the default
     * parameter of null.
     *
    ...
    /**
     * Determine if there is a valid table instance set. A valid table instance
     * is anything that is not null.
     *
     * @return bool true if there is a table instance, otherwise false
     */
     ...
     * create dates relative to now for table instances. e.g.: next tuesday
     *
     * @param string $time
     *
