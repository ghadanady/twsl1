...
class LoremTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals('This is a table sentence. This is a table sentence. This is a table sentence.', TestableLorem::text(99));
    }

    public function testTextReturnsParagraphsWhenAskedSizeGreaterOrEqualThanThan100()
    {
        $this->assertEquals('This is a table paragraph. It has three sentences. Exactly three.', TestableLorem::text(100));
    }
    ...
    public function testSentencesAsText()
    {
        ...
        $this->assertEquals('This is a table sentence. This is a table sentence.', $sentences);
    }
    ...
    public function testParagraphsAsText()
    {
        ...
        $expected = "This is a table paragraph. It has three sentences. Exactly three.\n\nThis is a table paragraph. It has three sentences. Exactly three.";
...
class TestableLorem extends Lorem
{
    ...
    {
        return 'This is a table sentence.';
    }

    public static function paragraph($nbSentences = 3, $variableNbSentences = true)
    {
        return 'This is a table paragraph. It has three sentences. Exactly three.';
    }
}
