 ...
 *
 * This class tests a large portion of all locale specific providers. It does not table the entire stack, because each
 * locale specific provider (can) has specific implementations. The goal of this table is to table the common denominator
...
class ProviderOverrideTest extends \PHPUnit_Framework_TestCase
{
     ...
     * PCRE for the tests, even though they seem fairly pointless, we table for incorrect encodings also.
     */
